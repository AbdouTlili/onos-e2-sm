...
type E2SmRsmEventTriggerDefinitionFormat1 struct {
	...
	// @inject_tag: aper:"valueExt,valueLB:0,valueUB:1"
	TriggerType RsmRicindicationTriggerType `protobuf:"varint,1,opt,name=trigger_type,json=triggerType,proto3,enum=e2sm_rsm.v1.RsmRicindicationTriggerType" json:"trigger_type,omitempty"`
	// @inject_tag: aper:"optional"
	ReportingPeriodMs *int32 `protobuf:"varint,2,opt,name=reporting_period_ms,json=reportingPeriod-ms,proto3,oneof" json:"reporting_period_ms,omitempty"`
}
...
type E2SmRsmIndicationHeaderFormat1 struct {
	...
	ColletStartTime *string `protobuf:"bytes,2,opt,name=collet_start_time,json=colletStartTime,proto3,oneof" json:"collet_start_time,omitempty"`
}
...
type E2SmRsmIndicationMessage_IndicationMessageFormat2 struct {
	...
	IndicationMessageFormat2 *E2SmRsmIndicationMessageFormat2 `protobuf:"bytes,2,opt,name=indication_message_format2,json=indicationMessage-Format2,proto3,oneof"`
}
...
type E2SmRsmIndicationMessageFormat2 struct {
	...
	TriggerType RsmEmmTriggerType `protobuf:"varint,1,opt,name=trigger_type,json=triggerType,proto3,enum=e2sm_rsm.v1.RsmEmmTriggerType" json:"trigger_type,omitempty"`
...
type SliceConfig struct {
	...
	SliceType SliceType `protobuf:"varint,4,opt,name=slice_type,json=sliceType,proto3,enum=e2sm_rsm.v1.SliceType" json:"slice_type,omitempty"`
}
...
type SliceDelete struct {
	...
	SliceId *SliceId `protobuf:"bytes,1,opt,name=slice_id,json=sliceID,proto3" json:"slice_id,omitempty"`
	// @inject_tag: aper:"valueLB:0,valueUB:1"
	SliceType SliceType `protobuf:"varint,2,opt,name=slice_type,json=sliceType,proto3,enum=e2sm_rsm.v1.SliceType" json:"slice_type,omitempty"`
}
