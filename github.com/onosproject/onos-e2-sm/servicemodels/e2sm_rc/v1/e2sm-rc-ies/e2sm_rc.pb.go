...
type NeighborCellList struct {
	...
	Value []*NeighborCellItem `protobuf:"bytes,1,rep,name=value,proto3" json:"value,omitempty"`
}
...
type NeighborCellItem_RanTypeChoiceNr struct {
	...
	RanTypeChoiceNr *NeighborCellItemChoiceNr `protobuf:"bytes,1,opt,name=ran_type_choice_nr,json=ranType-Choice-NR,proto3,oneof"`
}

type NeighborCellItem_RanTypeChoiceEutra struct {
	// @inject_tag: aper:"choiceIdx:2,valueExt"
	RanTypeChoiceEutra *NeighborCellItemChoiceEUtra `protobuf:"bytes,2,opt,name=ran_type_choice_eutra,json=ranType-Choice-EUTRA,proto3,oneof"`
}
...
type NeighborCellItemChoiceNr struct {
	...
	NRCgi     *e2sm_common_ies.NrCgi     `protobuf:"bytes,1,opt,name=n_r_cgi,json=nR-CGI,proto3" json:"n_r_cgi,omitempty"`
	...
	NRModeInfo NRModeInfo `protobuf:"varint,4,opt,name=n_r_mode_info,json=nR-mode-info,proto3,enum=e2sm_rc.v1.NRModeInfo" json:"n_r_mode_info,omitempty"`
	// @inject_tag: aper:"valueExt"
	NRFreqInfo *e2sm_common_ies.NrfrequencyInfo `protobuf:"bytes,5,opt,name=n_r_freq_info,json=nR-FreqInfo,proto3" json:"n_r_freq_info,omitempty"`
	// @inject_tag: aper:"valueLB:0,valueUB:1,valueExt"
	X2XnEstablished X2XNEstablished `protobuf:"varint,6,opt,name=x2_xn_established,json=x2-Xn-established,proto3,enum=e2sm_rc.v1.X2XNEstablished" json:"x2_xn_established,omitempty"`
	// @inject_tag: aper:"valueLB:0,valueUB:1,valueExt"
	HOValidated HOValidated `protobuf:"varint,7,opt,name=h_o_validated,json=hO-validated,proto3,enum=e2sm_rc.v1.HOValidated" json:"h_o_validated,omitempty"`
...
type NeighborCellItemChoiceEUtra struct {
	...
	// @inject_tag: aper:"valueExt"
	EUtraCgi   *e2sm_common_ies.EutraCgi   `protobuf:"bytes,1,opt,name=e_utra_cgi,json=eUTRA-CGI,proto3" json:"e_utra_cgi,omitempty"`
	...
	// @inject_tag: aper:"valueLB:0,valueUB:1,valueExt"
	X2XnEstablished X2XNEstablished `protobuf:"varint,5,opt,name=x2_xn_established,json=x2-Xn-established,proto3,enum=e2sm_rc.v1.X2XNEstablished" json:"x2_xn_established,omitempty"`
	// @inject_tag: aper:"valueLB:0,valueUB:1,valueExt"
	HOValidated HOValidated `protobuf:"varint,6,opt,name=h_o_validated,json=hO-validated,proto3,enum=e2sm_rc.v1.HOValidated" json:"h_o_validated,omitempty"`
	// @inject_tag: aper:"valueLB:1,valueUB:65535,valueExt"
...
type NeighborRelationInfo struct {
	...
	ServingCellPci *e2sm_common_ies.ServingCellPci `protobuf:"bytes,1,opt,name=serving_cell_pci,json=servingCellPCI,proto3" json:"serving_cell_pci,omitempty"`
	// @inject_tag: aper:"choiceExt"
	ServingCellArfcn *e2sm_common_ies.ServingCellArfcn `protobuf:"bytes,2,opt,name=serving_cell_arfcn,json=servingCellARFCN,proto3" json:"serving_cell_arfcn,omitempty"`
...
type EventTriggerCellInfo struct {
	...
	CellInfoList []*EventTriggerCellInfoItem `protobuf:"bytes,1,rep,name=cell_info_list,json=cellInfo-List,proto3" json:"cell_info_list,omitempty"`
}
...
type EventTriggerCellInfoItem struct {
	...
	// @inject_tag: aper:"choiceExt"
	CellType *CellType `protobuf:"bytes,2,opt,name=cell_type,json=cellType,proto3" json:"cell_type,omitempty"`
	// @inject_tag: aper:"optional,valueLB:0,valueUB:1,valueExt"
	LogicalOr *LogicalOr `protobuf:"varint,3,opt,name=logical_or,json=logicalOR,proto3,enum=e2sm_rc.v1.LogicalOr,oneof" json:"logical_or,omitempty"`
}
...
type CellType_CellTypeChoiceIndividual struct {
	// @inject_tag: aper:"choiceIdx:1,valueExt"
	CellTypeChoiceIndividual *EventTriggerCellInfoItemChoiceIndividual `protobuf:"bytes,1,opt,name=cell_type_choice_individual,json=cellTypeChoiceIndividual,proto3,oneof"`
}

type CellType_CellTypeChoiceGroup struct {
	// @inject_tag: aper:"choiceIdx:2,valueExt"
	CellTypeChoiceGroup *EventTriggerCellInfoItemChoiceGroup `protobuf:"bytes,2,opt,name=cell_type_choice_group,json=cellTypeChoiceGroup,proto3,oneof"`
}
...
type EventTriggerCellInfoItemChoiceIndividual struct {
	...
	// @inject_tag: aper:"choiceExt"
	CellGlobalId *e2sm_common_ies.Cgi `protobuf:"bytes,1,opt,name=cell_global_id,json=cellGlobalID,proto3" json:"cell_global_id,omitempty"`
}
...
type EventTriggerUeInfo struct {
	...
	UeInfoList []*EventTriggerUeInfoItem `protobuf:"bytes,1,rep,name=ue_info_list,json=ueInfo-List,proto3" json:"ue_info_list,omitempty"`
}
...
type EventTriggerUeInfoItem struct {
	...
	// @inject_tag: aper:"choiceExt"
	UeType *UeType `protobuf:"bytes,2,opt,name=ue_type,json=ueType,proto3" json:"ue_type,omitempty"`
	// @inject_tag: aper:"optional,valueLB:0,valueUB:1,valueExt"
	LogicalOr *LogicalOr `protobuf:"varint,3,opt,name=logical_or,json=logicalOR,proto3,enum=e2sm_rc.v1.LogicalOr,oneof" json:"logical_or,omitempty"`
}
...
type UeType_UeTypeChoiceIndividual struct {
	// @inject_tag: aper:"choiceIdx:1,valueExt"
	UeTypeChoiceIndividual *EventTriggerUeInfoItemChoiceIndividual `protobuf:"bytes,1,opt,name=ue_type_choice_individual,json=ueTypeChoiceIndividual,proto3,oneof"`
}

type UeType_UeTypeChoiceGroup struct {
	// @inject_tag: aper:"choiceIdx:2,valueExt"
	UeTypeChoiceGroup *EventTriggerUeInfoItemChoiceGroup `protobuf:"bytes,2,opt,name=ue_type_choice_group,json=ueTypeChoiceGroup,proto3,oneof"`
}
...
type EventTriggerUeInfoItemChoiceIndividual struct {
	...
	// @inject_tag: aper:"choiceExt"
	UeId                *e2sm_common_ies.Ueid `protobuf:"bytes,1,opt,name=ue_id,json=ueID,proto3" json:"ue_id,omitempty"`
...
type EventTriggerUeeventInfo struct {
	...
	// @inject_tag: aper:"sizeLB:1,sizeUB:65535,valueExt"
	UeEventList []*EventTriggerUeeventInfoItem `protobuf:"bytes,1,rep,name=ue_event_list,json=ueEvent-List,proto3" json:"ue_event_list,omitempty"`
}
...
type EventTriggerUeeventInfoItem struct {
	...
	// @inject_tag: aper:"optional,valueLB:0,valueUB:1,valueExt"
	LogicalOr *LogicalOr `protobuf:"varint,2,opt,name=logical_or,json=logicalOR,proto3,enum=e2sm_rc.v1.LogicalOr,oneof" json:"logical_or,omitempty"`
}
...
type RanparameterDefinition struct {
	...
	// @inject_tag: aper:"choiceExt"
	RanParameterDefinitionChoice *RanparameterDefinitionChoice `protobuf:"bytes,1,opt,name=ran_parameter_definition_choice,json=ranParameter-Definition-Choice,proto3" json:"ran_parameter_definition_choice,omitempty"`
}
...
type RanparameterDefinitionChoice_ChoiceList struct {
	// @inject_tag: aper:"choiceIdx:1,valueExt"
	ChoiceList *RanparameterDefinitionChoiceList `protobuf:"bytes,1,opt,name=choice_list,json=choiceLIST,proto3,oneof"`
}

type RanparameterDefinitionChoice_ChoiceStructure struct {
	// @inject_tag: aper:"choiceIdx:2,valueExt"
	ChoiceStructure *RanparameterDefinitionChoiceStructure `protobuf:"bytes,2,opt,name=choice_structure,json=choiceSTRUCTURE,proto3,oneof"`
}
...
type RanparameterDefinitionChoiceList struct {
	...
	// @inject_tag: aper:"sizeLB:1,sizeUB:65535,valueExt"
	RanParameterList []*RanparameterDefinitionChoiceListItem `protobuf:"bytes,1,rep,name=ran_parameter_list,json=ranParameter-List,proto3" json:"ran_parameter_list,omitempty"`
}
...
type RanparameterDefinitionChoiceListItem struct {
	...
	RanParameterDefinition *RanparameterDefinition `protobuf:"bytes,3,opt,name=ran_parameter_definition,json=ranParameter-Definition,proto3,oneof" json:"ran_parameter_definition,omitempty"`
}
...
type RanparameterDefinitionChoiceStructure struct {
	...
	// @inject_tag: aper:"sizeLB:1,sizeUB:65535,valueExt"
	RanParameterStructure []*RanparameterDefinitionChoiceStructureItem `protobuf:"bytes,1,rep,name=ran_parameter_structure,json=ranParameter-STRUCTURE,proto3" json:"ran_parameter_structure,omitempty"`
}
...
type RanparameterValueType_RanPChoiceElementTrue struct {
	// @inject_tag: aper:"choiceIdx:1,valueExt"
	RanPChoiceElementTrue *RanparameterValueTypeChoiceElementTrue `protobuf:"bytes,1,opt,name=ran_p_choice_element_true,json=ranP-Choice-ElementTrue,proto3,oneof"`
}

type RanparameterValueType_RanPChoiceElementFalse struct {
	// @inject_tag: aper:"choiceIdx:2,valueExt"
	RanPChoiceElementFalse *RanparameterValueTypeChoiceElementFalse `protobuf:"bytes,2,opt,name=ran_p_choice_element_false,json=ranP-Choice-ElementFalse,proto3,oneof"`
}

type RanparameterValueType_RanPChoiceStructure struct {
	// @inject_tag: aper:"choiceIdx:3,valueExt"
	RanPChoiceStructure *RanparameterValueTypeChoiceStructure `protobuf:"bytes,3,opt,name=ran_p_choice_structure,json=ranP-Choice-Structure,proto3,oneof"`
}

type RanparameterValueType_RanPChoiceList struct {
	// @inject_tag: aper:"choiceIdx:4,valueExt"
	RanPChoiceList *RanparameterValueTypeChoiceList `protobuf:"bytes,4,opt,name=ran_p_choice_list,json=ranP-Choice-List,proto3,oneof"`
}
...
type RanparameterValueTypeChoiceElementTrue struct {
	...
	// @inject_tag: aper:"choiceExt"
	RanParameterValue *RanparameterValue `protobuf:"bytes,1,opt,name=ran_parameter_value,json=ranParameter-value,proto3" json:"ran_parameter_value,omitempty"`
}
...
type RanparameterValueTypeChoiceElementFalse struct {
	...
	RanParameterValue *RanparameterValue `protobuf:"bytes,1,opt,name=ran_parameter_value,json=ranParameter-value,proto3,oneof" json:"ran_parameter_value,omitempty"`
}
...
type RanparameterValueTypeChoiceStructure struct {
	...
	// @inject_tag: aper:"valueExt"
	RanParameterStructure *RanparameterStructure `protobuf:"bytes,1,opt,name=ran_parameter_structure,json=ranParameter-Structure,proto3" json:"ran_parameter_structure,omitempty"`
}
...
type RanparameterValueTypeChoiceList struct {
	...
	// @inject_tag: aper:"valueExt"
	RanParameterList *RanparameterList `protobuf:"bytes,1,opt,name=ran_parameter_list,json=ranParameter-List,proto3" json:"ran_parameter_list,omitempty"`
}
...
type RanparameterStructure struct {
	...
	// @inject_tag: aper:"sizeLB:1,sizeUB:65535,valueExt"
	SequenceOfRanParameters []*RanparameterStructureItem `protobuf:"bytes,1,rep,name=sequence_of_ran_parameters,json=sequence-of-ranParameters,proto3" json:"sequence_of_ran_parameters,omitempty"`
}
...
type RanparameterStructureItem struct {
	...
	RanParameterId *RanparameterId `protobuf:"bytes,1,opt,name=ran_parameter_id,json=ranParameter-ID,proto3" json:"ran_parameter_id,omitempty"`
	// @inject_tag: aper:"choiceExt"
	RanParameterValueType *RanparameterValueType `protobuf:"bytes,2,opt,name=ran_parameter_value_type,json=ranParameter-valueType,proto3" json:"ran_parameter_value_type,omitempty"`
}
...
type RanparameterList struct {
	...
	// @inject_tag: aper:"sizeLB:1,sizeUB:65535,valueExt"
	ListOfRanParameter []*RanparameterStructure `protobuf:"bytes,1,rep,name=list_of_ran_parameter,json=list-of-ranParameter,proto3" json:"list_of_ran_parameter,omitempty"`
}
...
type RanparameterTesting struct {
	...
	Value []*RanparameterTestingItem `protobuf:"bytes,1,rep,name=value,proto3" json:"value,omitempty"`
}
...
type RanparameterTestingCondition_RanPChoiceComparison struct {
	...
	RanPChoiceComparison RanPChoiceComparison `protobuf:"varint,1,opt,name=ran_p_choice_comparison,json=ranP-Choice-comparison,proto3,enum=e2sm_rc.v1.RanPChoiceComparison,oneof"`
}

type RanparameterTestingCondition_RanPChoicePresence struct {
	// @inject_tag: aper:"choiceIdx:2,valueExt,valueLB:0,valueUB:3"
	RanPChoicePresence RanPChoicePresence `protobuf:"varint,2,opt,name=ran_p_choice_presence,json=ranP-Choice-presence,proto3,enum=e2sm_rc.v1.RanPChoicePresence,oneof"`
}
...
type RanparameterTestingItem struct {
	...
	RanParameterId *RanparameterId `protobuf:"bytes,1,opt,name=ran_parameter_id,json=ranParameter-ID,proto3" json:"ran_parameter_id,omitempty"`
	// @inject_tag: aper:"choiceExt"
	RanParameterType *RanParameterType `protobuf:"bytes,2,opt,name=ran_parameter_type,json=ranParameter-Type,proto3" json:"ran_parameter_type,omitempty"`
}
...
type RanParameterType_RanPChoiceList struct {
	// @inject_tag: aper:"choiceIdx:1,valueExt"
	RanPChoiceList *RanparameterTestingItemChoiceElementTrue `protobuf:"bytes,1,opt,name=ran_p_choice_list,json=ranPChoiceList,proto3,oneof"`
}

type RanParameterType_RanPChoiceStructure struct {
	// @inject_tag: aper:"choiceIdx:2,valueExt"
	RanPChoiceStructure *RanparameterTestingItemChoiceStructure `protobuf:"bytes,2,opt,name=ran_p_choice_structure,json=ranPChoiceStructure,proto3,oneof"`
}

type RanParameterType_RanPChoiceElementTrue struct {
	// @inject_tag: aper:"choiceIdx:3,valueExt"
	RanPChoiceElementTrue *RanparameterTestingItemChoiceElementTrue `protobuf:"bytes,3,opt,name=ran_p_choice_element_true,json=ranPChoiceElementTrue,proto3,oneof"`
}

type RanParameterType_RanPChoiceElementFalse struct {
	// @inject_tag: aper:"choiceIdx:4,valueExt"
	RanPChoiceElementFalse *RanparameterTestingItemChoiceElementFalse `protobuf:"bytes,4,opt,name=ran_p_choice_element_false,json=ranPChoiceElementFalse,proto3,oneof"`
}
...
type RanparameterTestingItemChoiceElementFalse struct {
	...
	// @inject_tag: aper:"choiceExt"
	RanParameterTestCondition *RanparameterTestingCondition `protobuf:"bytes,1,opt,name=ran_parameter_test_condition,json=ranParameter-TestCondition,proto3" json:"ran_parameter_test_condition,omitempty"`
	// @inject_tag: aper:"optional,choiceExt"
	RanParameterValue *RanparameterValue `protobuf:"bytes,2,opt,name=ran_parameter_value,json=ranParameter-Value,proto3,oneof" json:"ran_parameter_value,omitempty"`
	// @inject_tag: aper:"optional,valueLB:0,valueUB:1,valueExt"
	LogicalOr *LogicalOr `protobuf:"varint,3,opt,name=logical_or,json=logicalOR,proto3,enum=e2sm_rc.v1.LogicalOr,oneof" json:"logical_or,omitempty"`
}
...
type RicPolicyAction struct {
	...
	// @inject_tag: aper:"sizeLB:1,sizeUB:65535,valueExt"
	RanParametersList []*RicPolicyActionRanparameterItem `protobuf:"bytes,2,rep,name=ran_parameters_list,json=ranParameters-List,proto3" json:"ran_parameters_list,omitempty"`
}
...
type E2SmRcEventTrigger struct {
	...
	// @inject_tag: aper:"choiceExt"
	RicEventTriggerFormats *RicEventTriggerFormats `protobuf:"bytes,1,opt,name=ric_event_trigger_formats,json=ric-eventTrigger-formats,proto3" json:"ric_event_trigger_formats,omitempty"`
}
...
type RicEventTriggerFormats_EventTriggerFormat1 struct {
	// @inject_tag: aper:"choiceIdx:1,valueExt"
	EventTriggerFormat1 *E2SmRcEventTriggerFormat1 `protobuf:"bytes,1,opt,name=event_trigger_format1,json=eventTriggerFormat1,proto3,oneof"`
}

type RicEventTriggerFormats_EventTriggerFormat2 struct {
	// @inject_tag: aper:"choiceIdx:2,valueExt"
	EventTriggerFormat2 *E2SmRcEventTriggerFormat2 `protobuf:"bytes,2,opt,name=event_trigger_format2,json=eventTriggerFormat2,proto3,oneof"`
}

type RicEventTriggerFormats_EventTriggerFormat3 struct {
	// @inject_tag: aper:"choiceIdx:3,valueExt"
	EventTriggerFormat3 *E2SmRcEventTriggerFormat3 `protobuf:"bytes,3,opt,name=event_trigger_format3,json=eventTriggerFormat3,proto3,oneof"`
}

type RicEventTriggerFormats_EventTriggerFormat4 struct {
	// @inject_tag: aper:"choiceIdx:4,valueExt"
	EventTriggerFormat4 *E2SmRcEventTriggerFormat4 `protobuf:"bytes,4,opt,name=event_trigger_format4,json=eventTriggerFormat4,proto3,oneof"`
}

type RicEventTriggerFormats_EventTriggerFormat5 struct {
	// @inject_tag: aper:"choiceIdx:5,valueExt"
	EventTriggerFormat5 *E2SmRcEventTriggerFormat5 `protobuf:"bytes,5,opt,name=event_trigger_format5,json=eventTriggerFormat5,proto3,oneof"`
}
...
type E2SmRcEventTriggerFormat1 struct {
	...
	// @inject_tag: aper:"sizeLB:1,sizeUB:65535,valueExt"
	MessageList []*E2SmRcEventTriggerFormat1Item `protobuf:"bytes,1,rep,name=message_list,json=message-List,proto3" json:"message_list,omitempty"`
	// @inject_tag: aper:"optional,valueExt"
	GlobalAssociatedUeinfo *EventTriggerUeInfo `protobuf:"bytes,2,opt,name=global_associated_ueinfo,json=globalAssociatedUEInfo,proto3,oneof" json:"global_associated_ueinfo,omitempty"`
}
...
type E2SmRcEventTriggerFormat1Item struct {
	...
	// @inject_tag: aper:"choiceExt"
	MessageType *MessageTypeChoice `protobuf:"bytes,2,opt,name=message_type,json=messageType,proto3" json:"message_type,omitempty"`
	// @inject_tag: aper:"optional,valueLB:0,valueUB:1,valueExt"
	MessageDirection *MessageDirection `protobuf:"varint,3,opt,name=message_direction,json=messageDirection,proto3,enum=e2sm_rc.v1.MessageDirection,oneof" json:"message_direction,omitempty"`
	// @inject_tag: aper:"optional,valueExt"
	AssociatedUeinfo *EventTriggerUeInfo `protobuf:"bytes,4,opt,name=associated_ueinfo,json=associatedUEInfo,proto3,oneof" json:"associated_ueinfo,omitempty"`
	// @inject_tag: aper:"optional,valueExt"
	AssociatedUeevent *EventTriggerUeeventInfo `protobuf:"bytes,5,opt,name=associated_ueevent,json=associatedUEEvent,proto3,oneof" json:"associated_ueevent,omitempty"`
	// @inject_tag: aper:"optional,valueLB:0,valueUB:1,valueExt"
	LogicalOr *LogicalOr `protobuf:"varint,6,opt,name=logical_or,json=logicalOR,proto3,enum=e2sm_rc.v1.LogicalOr,oneof" json:"logical_or,omitempty"`
}
...
type MessageTypeChoice_MessageTypeChoiceNi struct {
	// @inject_tag: aper:"choiceIdx:1,valueExt"
	MessageTypeChoiceNi *MessageTypeChoiceNi `protobuf:"bytes,1,opt,name=message_type_choice_ni,json=messageType-Choice-NI,proto3,oneof"`
}

type MessageTypeChoice_MessageTypeChoiceRrc struct {
	// @inject_tag: aper:"choiceIdx:2,valueExt"
	MessageTypeChoiceRrc *MessageTypeChoiceRrc `protobuf:"bytes,2,opt,name=message_type_choice_rrc,json=messageType-Choice-RRC,proto3,oneof"`
}
...
type MessageTypeChoiceNi struct {
	...
	NIType e2sm_common_ies.InterfaceType `protobuf:"varint,1,opt,name=n_i_type,json=nI-Type,proto3,enum=e2sm_rc.v1.InterfaceType" json:"n_i_type,omitempty"`
	// @inject_tag: aper:"optional,choiceExt"
	NIIdentifier *e2sm_common_ies.InterfaceIdentifier `protobuf:"bytes,2,opt,name=n_i_identifier,json=nI-Identifier,proto3,oneof" json:"n_i_identifier,omitempty"`
	// @inject_tag: aper:"optional,valueExt"
	NIMessage *e2sm_common_ies.InterfaceMessageId `protobuf:"bytes,3,opt,name=n_i_message,json=nI-Message,proto3,oneof" json:"n_i_message,omitempty"`
}
...
type MessageTypeChoiceRrc struct {
	...
	// @inject_tag: aper:"valueExt"
	RRcMessage *e2sm_common_ies.RrcMessageId `protobuf:"bytes,1,opt,name=r_rc_message,json=rRC-Message,proto3" json:"r_rc_message,omitempty"`
}
...
type E2SmRcEventTriggerFormat2 struct {
	...
	AssociatedE2NodeInfo *RanparameterTesting `protobuf:"bytes,3,opt,name=associated_e2_node_info,json=associatedE2NodeInfo,proto3,oneof" json:"associated_e2_node_info,omitempty"`
	// @inject_tag: aper:"optional,valueExt"
	AssociatedUeinfo *EventTriggerUeInfo `protobuf:"bytes,4,opt,name=associated_ueinfo,json=associatedUEInfo,proto3,oneof" json:"associated_ueinfo,omitempty"`
}
...
type E2SmRcEventTriggerFormat3 struct {
	...
	// @inject_tag: aper:"sizeLB:1,sizeUB:65535,valueExt"
	E2NodeInfoChangeList []*E2SmRcEventTriggerFormat3Item `protobuf:"bytes,1,rep,name=e2_node_info_change_list,json=e2NodeInfoChange-List,proto3" json:"e2_node_info_change_list,omitempty"`
}
...
type E2SmRcEventTriggerFormat3Item struct {
	...
	E2NodeInfoChangeId int32 `protobuf:"varint,2,opt,name=e2_node_info_change_id,json=e2NodeInfoChange-ID,proto3" json:"e2_node_info_change_id,omitempty"`
	// @inject_tag: aper:"optional,valueExt"
	AssociatedCellInfo *EventTriggerCellInfo `protobuf:"bytes,3,opt,name=associated_cell_info,json=associatedCellInfo,proto3,oneof" json:"associated_cell_info,omitempty"`
	// @inject_tag: aper:"optional,valueLB:0,valueUB:1,valueExt"
	LogicalOr *LogicalOr `protobuf:"varint,4,opt,name=logical_or,json=logicalOR,proto3,enum=e2sm_rc.v1.LogicalOr,oneof" json:"logical_or,omitempty"`
}
...
type E2SmRcEventTriggerFormat4 struct {
	...
	// @inject_tag: aper:"sizeLB:1,sizeUB:65535,valueExt"
	UEinfoChangeList []*E2SmRcEventTriggerFormat4Item `protobuf:"bytes,1,rep,name=u_einfo_change_list,json=uEInfoChange-List,proto3" json:"u_einfo_change_list,omitempty"`
}
...
type E2SmRcEventTriggerFormat4Item struct {
	...
	RicEventTriggerConditionId *RicEventTriggerConditionId `protobuf:"bytes,1,opt,name=ric_event_trigger_condition_id,json=ric-eventTriggerCondition-ID,proto3" json:"ric_event_trigger_condition_id,omitempty"`
	// @inject_tag: aper:"choiceExt"
	TriggerType *TriggerTypeChoice `protobuf:"bytes,2,opt,name=trigger_type,json=triggerType,proto3" json:"trigger_type,omitempty"`
	// @inject_tag: aper:"optional,valueExt"
	AssociatedUeinfo *EventTriggerUeInfo `protobuf:"bytes,3,opt,name=associated_ueinfo,json=associatedUEInfo,proto3,oneof" json:"associated_ueinfo,omitempty"`
	// @inject_tag: aper:"optional,valueLB:0,valueUB:1,valueExt"
	LogicalOr *LogicalOr `protobuf:"varint,4,opt,name=logical_or,json=logicalOR,proto3,enum=e2sm_rc.v1.LogicalOr,oneof" json:"logical_or,omitempty"`
}
...
type TriggerTypeChoice_TriggerTypeChoiceRrcstate struct {
	// @inject_tag: aper:"choiceIdx:1,valueExt"
	TriggerTypeChoiceRrcstate *TriggerTypeChoiceRrcstate `protobuf:"bytes,1,opt,name=trigger_type_choice_rrcstate,json=triggerType-Choice-RRCstate,proto3,oneof"`
}

type TriggerTypeChoice_TriggerTypeChoiceUeid struct {
	// @inject_tag: aper:"choiceIdx:2,valueExt"
	TriggerTypeChoiceUeid *TriggerTypeChoiceUeid `protobuf:"bytes,2,opt,name=trigger_type_choice_ueid,json=triggerType-Choice-UEID,proto3,oneof"`
}

type TriggerTypeChoice_TriggerTypeChoiceL2State struct {
	// @inject_tag: aper:"choiceIdx:3,valueExt"
	TriggerTypeChoiceL2State *TriggerTypeChoiceL2State `protobuf:"bytes,3,opt,name=trigger_type_choice_l2state,json=triggerType-Choice-L2state,proto3,oneof"`
}
...
type TriggerTypeChoiceRrcstate struct {
	...
	RrcStateList []*TriggerTypeChoiceRrcstateItem `protobuf:"bytes,1,rep,name=rrc_state_list,json=rrcState-List,proto3" json:"rrc_state_list,omitempty"`
}
...
type TriggerTypeChoiceRrcstateItem struct {
	...
	StateChangedTo RrcState `protobuf:"varint,1,opt,name=state_changed_to,json=stateChangedTo,proto3,enum=e2sm_rc.v1.RrcState" json:"state_changed_to,omitempty"`
	// @inject_tag: aper:"optional,valueLB:0,valueUB:1,valueExt"
	LogicalOr *LogicalOr `protobuf:"varint,2,opt,name=logical_or,json=logicalOR,proto3,enum=e2sm_rc.v1.LogicalOr,oneof" json:"logical_or,omitempty"`
}
...
type TriggerTypeChoiceUeid struct {
	...
	// @inject_tag: aper:"valueLB:1,valueUB:512,valueExt"
	UeIdchangeId int32 `protobuf:"varint,1,opt,name=ue_idchange_id,json=ueIDchange-ID,proto3" json:"ue_idchange_id,omitempty"`
}
...
type E2SmRcEventTriggerFormat5 struct {
	...
	// @inject_tag: aper:"valueLB:0,valueUB:1,valueExt"
	OnDemand OnDemand `protobuf:"varint,1,opt,name=on_demand,json=onDemand,proto3,enum=e2sm_rc.v1.OnDemand" json:"on_demand,omitempty"`
	// @inject_tag: aper:"optional,valueExt"
	AssociatedUeinfo *EventTriggerUeInfo `protobuf:"bytes,2,opt,name=associated_ueinfo,json=associatedUEInfo,proto3,oneof" json:"associated_ueinfo,omitempty"`
	// @inject_tag: aper:"optional,valueExt"
	AssociatedCellInfo *EventTriggerCellInfo `protobuf:"bytes,3,opt,name=associated_cell_info,json=associatedCellInfo,proto3,oneof" json:"associated_cell_info,omitempty"`
}
...
type E2SmRcActionDefinition struct {
	...
	// @inject_tag: aper:"choiceExt"
	RicActionDefinitionFormats *RicActionDefinitionFormats `protobuf:"bytes,2,opt,name=ric_action_definition_formats,json=ric-actionDefinition-formats,proto3" json:"ric_action_definition_formats,omitempty"`
}
...
type RicActionDefinitionFormats_ActionDefinitionFormat1 struct {
	// @inject_tag: aper:"choiceIdx:1,valueExt"
	ActionDefinitionFormat1 *E2SmRcActionDefinitionFormat1 `protobuf:"bytes,1,opt,name=action_definition_format1,json=actionDefinitionFormat1,proto3,oneof"`
}

type RicActionDefinitionFormats_ActionDefinitionFormat2 struct {
	// @inject_tag: aper:"choiceIdx:3,valueExt"
	ActionDefinitionFormat2 *E2SmRcActionDefinitionFormat2 `protobuf:"bytes,2,opt,name=action_definition_format2,json=actionDefinitionFormat2,proto3,oneof"`
}

type RicActionDefinitionFormats_ActionDefinitionFormat3 struct {
	// @inject_tag: aper:"choiceIdx:3,valueExt"
	ActionDefinitionFormat3 *E2SmRcActionDefinitionFormat3 `protobuf:"bytes,3,opt,name=action_definition_format3,json=actionDefinitionFormat3,proto3,oneof"`
}
...
type E2SmRcActionDefinitionFormat1 struct {
	...
	// @inject_tag: aper:"sizeLB:1,sizeUB:65535,valueExt"
	RanPToBeReportedList []*E2SmRcActionDefinitionFormat1Item `protobuf:"bytes,1,rep,name=ran_p_to_be_reported_list,json=ranP-ToBeReported-List,proto3" json:"ran_p_to_be_reported_list,omitempty"`
}
...
type E2SmRcActionDefinitionFormat2 struct {
	...
	// @inject_tag: aper:"sizeLB:1,sizeUB:65535,valueExt"
	RicPolicyConditionsList []*E2SmRcActionDefinitionFormat2Item `protobuf:"bytes,1,rep,name=ric_policy_conditions_list,json=ric-PolicyConditions-List,proto3" json:"ric_policy_conditions_list,omitempty"`
}
...
type E2SmRcActionDefinitionFormat2Item struct {
	...
	// @inject_tag: aper:"valueExt"
	RicPolicyAction *RicPolicyAction `protobuf:"bytes,1,opt,name=ric_policy_action,json=ric-PolicyAction,proto3" json:"ric_policy_action,omitempty"`
	// @inject_tag: aper:"optional"
	RicPolicyConditionDefinition *RanparameterTesting `protobuf:"bytes,2,opt,name=ric_policy_condition_definition,json=ric-PolicyConditionDefinition,proto3,oneof" json:"ric_policy_condition_definition,omitempty"`
}
...
type E2SmRcActionDefinitionFormat3 struct {
	...
	// @inject_tag: aper:"sizeLB:1,sizeUB:65535,valueExt"
	RanPInsertIndicationList []*E2SmRcActionDefinitionFormat3Item `protobuf:"bytes,2,rep,name=ran_p_insert_indication_list,json=ranP-InsertIndication-List,proto3" json:"ran_p_insert_indication_list,omitempty"`
	// @inject_tag: aper:"optional,choiceExt"
	UeId *e2sm_common_ies.Ueid `protobuf:"bytes,3,opt,name=ue_id,json=ueID,proto3,oneof" json:"ue_id,omitempty"`
}
...
type E2SmRcIndicationHeader struct {
	...
	// @inject_tag: aper:"choiceExt"
	RicIndicationHeaderFormats *RicIndicationHeaderFormats `protobuf:"bytes,1,opt,name=ric_indication_header_formats,json=ric-indicationHeader-formats,proto3" json:"ric_indication_header_formats,omitempty"`
}
...
type RicIndicationHeaderFormats_IndicationHeaderFormat1 struct {
	// @inject_tag: aper:"choiceIdx:1,valueExt"
	IndicationHeaderFormat1 *E2SmRcIndicationHeaderFormat1 `protobuf:"bytes,1,opt,name=indication_header_format1,json=indicationHeaderFormat1,proto3,oneof"`
}

type RicIndicationHeaderFormats_IndicationHeaderFormat2 struct {
	// @inject_tag: aper:"choiceIdx:2,valueExt"
	IndicationHeaderFormat2 *E2SmRcIndicationHeaderFormat2 `protobuf:"bytes,2,opt,name=indication_header_format2,json=indicationHeaderFormat2,proto3,oneof"`
}
...
type E2SmRcIndicationHeaderFormat1 struct {
	...
	RicEventTriggerConditionId *RicEventTriggerConditionId `protobuf:"bytes,1,opt,name=ric_event_trigger_condition_id,json=ric-eventTriggerCondition-ID,proto3,oneof" json:"ric_event_trigger_condition_id,omitempty"`
}
...
type E2SmRcIndicationMessage struct {
	...
	// @inject_tag: aper:"choiceExt"
	RicIndicationMessageFormats *RicIndicationMessageFormats `protobuf:"bytes,1,opt,name=ric_indication_message_formats,json=ric-indicationMessage-formats,proto3" json:"ric_indication_message_formats,omitempty"`
}
...
type RicIndicationMessageFormats_IndicationMessageFormat1 struct {
	// @inject_tag: aper:"choiceIdx:1,valueExt"
	IndicationMessageFormat1 *E2SmRcIndicationMessageFormat1 `protobuf:"bytes,1,opt,name=indication_message_format1,json=indicationMessageFormat1,proto3,oneof"`
}

type RicIndicationMessageFormats_IndicationMessageFormat2 struct {
	// @inject_tag: aper:"choiceIdx:2,valueExt"
	IndicationMessageFormat2 *E2SmRcIndicationMessageFormat2 `protobuf:"bytes,2,opt,name=indication_message_format2,json=indicationMessageFormat2,proto3,oneof"`
}

type RicIndicationMessageFormats_IndicationMessageFormat3 struct {
	// @inject_tag: aper:"choiceIdx:3,valueExt"
	IndicationMessageFormat3 *E2SmRcIndicationMessageFormat3 `protobuf:"bytes,3,opt,name=indication_message_format3,json=indicationMessageFormat3,proto3,oneof"`
}

type RicIndicationMessageFormats_IndicationMessageFormat4 struct {
	// @inject_tag: aper:"choiceIdx:4,valueExt"
	IndicationMessageFormat4 *E2SmRcIndicationMessageFormat4 `protobuf:"bytes,4,opt,name=indication_message_format4,json=indicationMessageFormat4,proto3,oneof"`
}

type RicIndicationMessageFormats_IndicationMessageFormat5 struct {
	// @inject_tag: aper:"choiceIdx:5,valueExt"
	IndicationMessageFormat5 *E2SmRcIndicationMessageFormat5 `protobuf:"bytes,5,opt,name=indication_message_format5,json=indicationMessageFormat5,proto3,oneof"`
}
...
type E2SmRcIndicationMessageFormat1 struct {
	...
	// @inject_tag: aper:"sizeLB:1,sizeUB:65535,valueExt"
	RanPReportedList []*E2SmRcIndicationMessageFormat1Item `protobuf:"bytes,1,rep,name=ran_p_reported_list,json=ranP-Reported-List,proto3" json:"ran_p_reported_list,omitempty"`
}
...
type E2SmRcIndicationMessageFormat2 struct {
	...
	// @inject_tag: aper:"sizeLB:1,sizeUB:65535,valueExt"
	UeParameterList []*E2SmRcIndicationMessageFormat2Item `protobuf:"bytes,1,rep,name=ue_parameter_list,json=ueParameter-List,proto3" json:"ue_parameter_list,omitempty"`
}
...
type E2SmRcIndicationMessageFormat2Item struct {
	...
	UeId *e2sm_common_ies.Ueid `protobuf:"bytes,1,opt,name=ue_id,json=ueID,proto3" json:"ue_id,omitempty"`
	// @inject_tag: aper:"sizeLB:1,sizeUB:65535,valueExt"
	RanPList []*E2SmRcIndicationMessageFormat2RanparameterItem `protobuf:"bytes,2,rep,name=ran_p_list,json=ranP-List,proto3" json:"ran_p_list,omitempty"`
}
...
type E2SmRcIndicationMessageFormat3 struct {
	...
	// @inject_tag: aper:"sizeLB:1,sizeUB:65535,valueExt"
	CellInfoList []*E2SmRcIndicationMessageFormat3Item `protobuf:"bytes,1,rep,name=cell_info_list,json=cellInfo-List,proto3" json:"cell_info_list,omitempty"`
}
...
type E2SmRcIndicationMessageFormat3Item struct {
	...
	// @inject_tag: aper:"choiceIdx:1,valueExt"
	CellGlobalId *e2sm_common_ies.Cgi `protobuf:"bytes,1,opt,name=cell_global_id,json=cellGlobal-ID,proto3" json:"cell_global_id,omitempty"`
	// @inject_tag: aper:"optional"
	CellContextInfo []byte `protobuf:"bytes,2,opt,name=cell_context_info,json=cellContextInfo,proto3,oneof" json:"cell_context_info,omitempty"`
	// @inject_tag: aper:"optional"
	CellDeleted *bool `protobuf:"varint,3,opt,name=cell_deleted,json=cellDeleted,proto3,oneof" json:"cell_deleted,omitempty"`
	// @inject_tag: aper:"optional,valueExt"
	NeighborRelationTable *NeighborRelationInfo `protobuf:"bytes,4,opt,name=neighbor_relation_table,json=neighborRelation-Table,proto3,oneof" json:"neighbor_relation_table,omitempty"`
}
...
type E2SmRcIndicationMessageFormat4 struct {
	...
	// @inject_tag: aper:"sizeLB:0,sizeUB:65535,valueExt"
	UeInfoList []*E2SmRcIndicationMessageFormat4ItemUe `protobuf:"bytes,1,rep,name=ue_info_list,json=ueInfo-List,proto3" json:"ue_info_list,omitempty"`
	// @inject_tag: aper:"sizeLB:0,sizeUB:65535,valueExt"
	CellInfoList []*E2SmRcIndicationMessageFormat4ItemCell `protobuf:"bytes,2,rep,name=cell_info_list,json=cellInfo-List,proto3" json:"cell_info_list,omitempty"`
}
...
type E2SmRcIndicationMessageFormat4ItemUe struct {
	...
	UeId *e2sm_common_ies.Ueid `protobuf:"bytes,1,opt,name=ue_id,json=ueID,proto3" json:"ue_id,omitempty"`
	// @inject_tag: aper:"optional"
	UeContextInfo []byte `protobuf:"bytes,2,opt,name=ue_context_info,json=ueContextInfo,proto3,oneof" json:"ue_context_info,omitempty"`
	// @inject_tag: aper:"choiceExt"
	CellGlobalId *e2sm_common_ies.Cgi `protobuf:"bytes,3,opt,name=cell_global_id,json=cellGlobal-ID,proto3" json:"cell_global_id,omitempty"`
}
...
type E2SmRcIndicationMessageFormat4ItemCell struct {
	...
	CellContextInfo []byte `protobuf:"bytes,2,opt,name=cell_context_info,json=cellContextInfo,proto3,oneof" json:"cell_context_info,omitempty"`
	// @inject_tag: aper:"optional,valueExt"
	NeighborRelationTable *NeighborRelationInfo `protobuf:"bytes,3,opt,name=neighbor_relation_table,json=neighborRelation-Table,proto3,oneof" json:"neighbor_relation_table,omitempty"`
}
...
type E2SmRcIndicationMessageFormat5 struct {
	...
	// @inject_tag: aper:"sizeLB:0,sizeUB:65535,valueExt"
	RanPRequestedList []*E2SmRcIndicationMessageFormat5Item `protobuf:"bytes,1,rep,name=ran_p_requested_list,json=ranP-Requested-List,proto3" json:"ran_p_requested_list,omitempty"`
}
...
type E2SmRcCallProcessId struct {
	...
	// @inject_tag: aper:"choiceExt"
	RicCallProcessIdFormats *RicCallProcessIdFormats `protobuf:"bytes,1,opt,name=ric_call_process_id_formats,json=ric-callProcessID-formats,proto3" json:"ric_call_process_id_formats,omitempty"`
}
...
type RicCallProcessIdFormats_CallProcessIdFormat1 struct {
	// @inject_tag: aper:"choiceIdx:1,valueExt"
	CallProcessIdFormat1 *E2SmRcCallProcessIdFormat1 `protobuf:"bytes,1,opt,name=call_process_id_format1,json=callProcessIdFormat1,proto3,oneof"`
}
...
type E2SmRcControlHeader struct {
	...
	// @inject_tag: aper:"choiceExt"
	RicControlHeaderFormats *RicControlHeaderFormats `protobuf:"bytes,1,opt,name=ric_control_header_formats,json=ric-controlHeader-formats,proto3" json:"ric_control_header_formats,omitempty"`
}
...
type RicControlHeaderFormats_ControlHeaderFormat1 struct {
	// @inject_tag: aper:"choiceIdx:1,valueExt"
	ControlHeaderFormat1 *E2SmRcControlHeaderFormat1 `protobuf:"bytes,1,opt,name=control_header_format1,json=controlHeaderFormat1,proto3,oneof"`
}
...
type E2SmRcControlHeaderFormat1 struct {
	...
	// @inject_tag: aper:"optional,valueLB:0,valueUB:1,valueExt"
	RicControlDecision *RicControlDecision `protobuf:"varint,4,opt,name=ric_control_decision,json=ric-ControlDecision,proto3,enum=e2sm_rc.v1.RicControlDecision,oneof" json:"ric_control_decision,omitempty"`
}
...
type E2SmRcControlMessage struct {
	...
	// @inject_tag: aper:"choiceExt"
	RicControlMessageFormats *RicControlMessageFormats `protobuf:"bytes,1,opt,name=ric_control_message_formats,json=ric-controlMessage-formats,proto3" json:"ric_control_message_formats,omitempty"`
}
...
type RicControlMessageFormats_ControlMessageFormat1 struct {
	// @inject_tag: aper:"choiceIdx:1,valueExt"
	ControlMessageFormat1 *E2SmRcControlMessageFormat1 `protobuf:"bytes,1,opt,name=control_message_format1,json=controlMessageFormat1,proto3,oneof"`
}
...
type E2SmRcControlMessageFormat1 struct {
	...
	// @inject_tag: aper:"sizeLB:0,sizeUB:65535,valueExt"
	RanPList []*E2SmRcControlMessageFormat1Item `protobuf:"bytes,1,rep,name=ran_p_list,json=ranP-List,proto3" json:"ran_p_list,omitempty"`
}
...
type E2SmRcControlOutcome struct {
	...
	// @inject_tag: aper:"choiceExt"
	RicControlOutcomeFormats *RicControlOutcomeFormats `protobuf:"bytes,1,opt,name=ric_control_outcome_formats,json=ric-controlOutcome-formats,proto3" json:"ric_control_outcome_formats,omitempty"`
}
...
type RicControlOutcomeFormats_ControlOutcomeFormat1 struct {
	// @inject_tag: aper:"choiceIdx:1,valueExt"
	ControlOutcomeFormat1 *E2SmRcControlOutcomeFormat1 `protobuf:"bytes,1,opt,name=control_outcome_format1,json=controlOutcomeFormat1,proto3,oneof"`
}
...
type E2SmRcControlOutcomeFormat1 struct {
	...
	RanPList []*E2SmRcControlOutcomeFormat1Item `protobuf:"bytes,1,rep,name=ran_p_list,json=ranP-List,proto3" json:"ran_p_list,omitempty"`
}
...
type E2SmRcControlOutcomeFormat1Item struct {
	...
	RanParameterId *RanparameterId `protobuf:"bytes,1,opt,name=ran_parameter_id,json=ranParameter-ID,proto3" json:"ran_parameter_id,omitempty"`
	// @inject_tag: aper:"choiceExt"
	RanParameterValue *RanparameterValue `protobuf:"bytes,2,opt,name=ran_parameter_value,json=ranParameter-value,proto3" json:"ran_parameter_value,omitempty"`
}
...
type E2SmRcRanfunctionDefinition struct {
	...
	// @inject_tag: aper:"valueExt"
	RanFunctionName *e2sm_common_ies.RanfunctionName `protobuf:"bytes,1,opt,name=ran_function_name,json=ranFunction-Name,proto3" json:"ran_function_name,omitempty"`
	// @inject_tag: aper:"optional,valueExt"
	RanFunctionDefinitionEventTrigger *RanfunctionDefinitionEventTrigger `protobuf:"bytes,2,opt,name=ran_function_definition_event_trigger,json=ranFunctionDefinition-EventTrigger,proto3,oneof" json:"ran_function_definition_event_trigger,omitempty"`
	// @inject_tag: aper:"optional,valueExt"
	RanFunctionDefinitionReport *RanfunctionDefinitionReport `protobuf:"bytes,3,opt,name=ran_function_definition_report,json=ranFunctionDefinition-Report,proto3,oneof" json:"ran_function_definition_report,omitempty"`
	// @inject_tag: aper:"optional,valueExt"
	RanFunctionDefinitionInsert *RanfunctionDefinitionInsert `protobuf:"bytes,4,opt,name=ran_function_definition_insert,json=ranFunctionDefinition-Insert,proto3,oneof" json:"ran_function_definition_insert,omitempty"`
	// @inject_tag: aper:"optional,valueExt"
	RanFunctionDefinitionControl *RanfunctionDefinitionControl `protobuf:"bytes,5,opt,name=ran_function_definition_control,json=ranFunctionDefinition-Control,proto3,oneof" json:"ran_function_definition_control,omitempty"`
	// @inject_tag: aper:"optional,valueExt"
	RanFunctionDefinitionPolicy *RanfunctionDefinitionPolicy `protobuf:"bytes,6,opt,name=ran_function_definition_policy,json=ranFunctionDefinition-Policy,proto3,oneof" json:"ran_function_definition_policy,omitempty"`
}
...
type RanfunctionDefinitionEventTrigger struct {
	...
	RicEventTriggerStyleList []*RanfunctionDefinitionEventTriggerStyleItem `protobuf:"bytes,1,rep,name=ric_event_trigger_style_list,json=ric-EventTriggerStyle-List,proto3" json:"ric_event_trigger_style_list,omitempty"`
	// @inject_tag: aper:"optional,sizeLB:1,sizeUB:65535,valueExt"
	RanL2ParametersList []*L2ParametersRanparameterItem `protobuf:"bytes,2,rep,name=ran_l2_parameters_list,json=ran-L2Parameters-List,proto3" json:"ran_l2_parameters_list,omitempty"`
	// @inject_tag: aper:"optional,sizeLB:1,sizeUB:65535,valueExt"
	RanCallProcessTypesList []*RanfunctionDefinitionEventTriggerCallProcessItem `protobuf:"bytes,3,rep,name=ran_call_process_types_list,json=ran-CallProcessTypes-List,proto3" json:"ran_call_process_types_list,omitempty"`
	// @inject_tag: aper:"optional,sizeLB:1,sizeUB:65535,valueExt"
	RanUeidentificationParametersList []*UeidentificationRanparameterItem `protobuf:"bytes,4,rep,name=ran_ueidentification_parameters_list,json=ran-UEIdentificationParameters-List,proto3" json:"ran_ueidentification_parameters_list,omitempty"`
	// @inject_tag: aper:"optional,sizeLB:1,sizeUB:65535,valueExt"
	RanCellIdentificationParametersList []*CellIdentificationRanparameterItem `protobuf:"bytes,5,rep,name=ran_cell_identification_parameters_list,json=ran-CellIdentificationParameters-List,proto3" json:"ran_cell_identification_parameters_list,omitempty"`
}
...
type RanfunctionDefinitionEventTriggerCallProcessItem struct {
	...
	// @inject_tag: aper:"sizeLB:1,sizeUB:65535,valueExt"
	CallProcessBreakpointsList []*RanfunctionDefinitionEventTriggerBreakpointItem `protobuf:"bytes,3,rep,name=call_process_breakpoints_list,json=callProcessBreakpoints-List,proto3" json:"call_process_breakpoints_list,omitempty"`
}
...
type RanfunctionDefinitionEventTriggerBreakpointItem struct {
	...
	// @inject_tag: aper:"optional,sizeLB:1,sizeUB:65535,valueExt"
	RanCallProcessBreakpointParametersList []*CallProcessBreakpointRanparameterItem `protobuf:"bytes,3,rep,name=ran_call_process_breakpoint_parameters_list,json=ran-CallProcessBreakpointParameters-List,proto3" json:"ran_call_process_breakpoint_parameters_list,omitempty"`
}
...
type RanfunctionDefinitionReport struct {
	...
	RicReportStyleList []*RanfunctionDefinitionReportItem `protobuf:"bytes,1,rep,name=ric_report_style_list,json=ric-ReportStyle-List,proto3" json:"ric_report_style_list,omitempty"`
}
...
type RanfunctionDefinitionReportItem struct {
	...
	// @inject_tag: aper:"optional,sizeLB:1,sizeUB:65535,valueExt"
	RanReportParametersList []*ReportRanparameterItem `protobuf:"bytes,7,rep,name=ran_report_parameters_list,json=ran-ReportParameters-List,proto3" json:"ran_report_parameters_list,omitempty"`
}
...
type RanfunctionDefinitionInsert struct {
	...
	RicInsertStyleList []*RanfunctionDefinitionInsertItem `protobuf:"bytes,1,rep,name=ric_insert_style_list,json=ric-InsertStyle-List,proto3" json:"ric_insert_style_list,omitempty"`
}
...
type RanfunctionDefinitionInsertItem struct {
	...
	// @inject_tag: aper:"optional,sizeLB:1,sizeUB:65535,valueExt"
	RicInsertIndicationList        []*RanfunctionDefinitionInsertIndicationItem `protobuf:"bytes,5,rep,name=ric_insert_indication_list,json=ric-InsertIndication-List,proto3" json:"ric_insert_indication_list,omitempty"`
...
type RanfunctionDefinitionInsertIndicationItem struct {
	...
	// @inject_tag: aper:"optional,sizeLB:1,sizeUB:65535,valueExt"
	RanInsertIndicationParametersList []*InsertIndicationRanparameterItem `protobuf:"bytes,3,rep,name=ran_insert_indication_parameters_list,json=ran-InsertIndicationParameters-List,proto3" json:"ran_insert_indication_parameters_list,omitempty"`
}
...
type RanfunctionDefinitionControl struct {
	...
	// @inject_tag: aper:"sizeLB:1,sizeUB:63,valueExt"
	RicControlStyleList []*RanfunctionDefinitionControlItem `protobuf:"bytes,1,rep,name=ric_control_style_list,json=ric-ControlStyle-List,proto3" json:"ric_control_style_list,omitempty"`
}
...
type RanfunctionDefinitionControlItem struct {
	...
	// @inject_tag: aper:"optional,sizeLB:1,sizeUB:65535,valueExt"
	RicControlActionList        []*RanfunctionDefinitionControlActionItem `protobuf:"bytes,3,rep,name=ric_control_action_list,json=ric-ControlAction-List,proto3" json:"ric_control_action_list,omitempty"`
	...
	// @inject_tag: aper:"optional"
	RicCallProcessIdformatType  *e2sm_common_ies.RicFormatType `protobuf:"bytes,6,opt,name=ric_call_process_idformat_type,json=ric-CallProcessIDFormat-Type,proto3,oneof" json:"ric_call_process_idformat_type,omitempty"`
	...
	RanControlOutcomeParametersList []*ControlOutcomeRanparameterItem `protobuf:"bytes,8,rep,name=ran_control_outcome_parameters_list,json=ran-ControlOutcomeParameters-List,proto3" json:"ran_control_outcome_parameters_list,omitempty"`
}
...
type RanfunctionDefinitionControlActionItem struct {
	...
	// @inject_tag: aper:"optional,sizeLB:1,sizeUB:65535,valueExt"
	RanControlActionParametersList []*ControlActionRanparameterItem `protobuf:"bytes,3,rep,name=ran_control_action_parameters_list,json=ran-ControlActionParameters-List,proto3" json:"ran_control_action_parameters_list,omitempty"`
}
...
type RanfunctionDefinitionPolicy struct {
	...
	// @inject_tag: aper:"sizeLB:1,sizeUB:63,valueExt"
	RicPolicyStyleList []*RanfunctionDefinitionPolicyItem `protobuf:"bytes,1,rep,name=ric_policy_style_list,json=ric-PolicyStyle-List,proto3" json:"ric_policy_style_list,omitempty"`
}
...
type RanfunctionDefinitionPolicyItem struct {
	...
	RicSupportedEventTriggerStyleType *e2sm_common_ies.RicStyleType `protobuf:"bytes,3,opt,name=ric_supported_event_trigger_style_type,json=ric-SupportedEventTriggerStyle-Type,proto3" json:"ric_supported_event_trigger_style_type,omitempty"`
	// @inject_tag: aper:"optional,sizeLB:1,sizeUB:65535,valueExt"
	RicPolicyActionList []*RanfunctionDefinitionPolicyActionItem `protobuf:"bytes,4,rep,name=ric_policy_action_list,json=ric-PolicyAction-List,proto3" json:"ric_policy_action_list,omitempty"`
}
...
type RanfunctionDefinitionPolicyActionItem struct {
	...
	// @inject_tag: aper:"optional,sizeLB:1,sizeUB:65535,valueExt"
	RanPolicyActionParametersList []*PolicyActionRanparameterItem `protobuf:"bytes,4,rep,name=ran_policy_action_parameters_list,json=ran-PolicyActionParameters-List,proto3" json:"ran_policy_action_parameters_list,omitempty"`
	// @inject_tag: aper:"optional,sizeLB:1,sizeUB:65535,valueExt"
	RanPolicyConditionParametersList []*PolicyConditionRanparameterItem `protobuf:"bytes,5,rep,name=ran_policy_condition_parameters_list,json=ran-PolicyConditionParameters-List,proto3" json:"ran_policy_condition_parameters_list,omitempty"`
}
