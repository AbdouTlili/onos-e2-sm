...
type InterfaceIdXn struct {
	...
	GlobalNgRanId *GlobalNgrannodeId `protobuf:"bytes,1,opt,name=global_ng_ran_id,json=global-NG-RAN-ID,proto3" json:"global_ng_ran_id,omitempty"`
}
...
type InterfaceIdF1 struct {
	...
	// @inject_tag: aper:"valueExt"
	GlobalGnbId *GlobalGnbId `protobuf:"bytes,1,opt,name=global_gnb_id,json=globalGNB-ID,proto3" json:"global_gnb_id,omitempty"`
...
type NodeType_GlobalEnbId struct {
	// @inject_tag: aper:"choiceIdx:1,valueExt"
	GlobalEnbId *GlobalEnbId `protobuf:"bytes,1,opt,name=global_enb_id,json=globalEnbId,proto3,oneof"`
}

type NodeType_GlobalEnGnbId struct {
	// @inject_tag: aper:"choiceIdx:2,valueExt"
	GlobalEnGnbId *GlobalenGnbId `protobuf:"bytes,2,opt,name=global_en_gnb_id,json=globalEnGnbId,proto3,oneof"`
}
...
type InterfaceMessageId struct {
	...
	MessageType MessageType `protobuf:"varint,2,opt,name=message_type,json=messageType,proto3,enum=e2sm_rc.v1.MessageType" json:"message_type,omitempty"`
}
...
type RrcType_Lte struct {
	...
	Lte RrcclassLte `protobuf:"varint,1,opt,name=lte,proto3,enum=e2sm_rc.v1.RrcclassLte,oneof"`
}

type RrcType_Nr struct {
	// @inject_tag: aper:"choiceIdx:2,valueExt,valueLB:0,valueUB:7"
	Nr RrcclassNr `protobuf:"varint,2,opt,name=nr,proto3,enum=e2sm_rc.v1.RrcclassNr,oneof"`
}
...
type UeidGnb struct {
	...
	GlobalNgRannodeId *GlobalNgrannodeId `protobuf:"bytes,8,opt,name=global_ng_rannode_id,json=globalNG-RANNode-ID,proto3,oneof" json:"global_ng_rannode_id,omitempty"`
}
...
type UeidNgEnb struct {
	...
	// @inject_tag: aper:"optional,choiceExt,fromValueExt"
	GlobalNgRannodeId *GlobalNgrannodeId `protobuf:"bytes,6,opt,name=global_ng_rannode_id,json=globalNG-RANNode-ID,proto3,oneof" json:"global_ng_rannode_id,omitempty"`
}
...
type NrfrequencyInfo struct {
	...
	FrequencyShift7P5Khz *NrfrequencyShift7P5Khz `protobuf:"varint,3,opt,name=frequency_shift7p5khz,json=frequencyShift7p5khz,proto3,enum=e2sm_rc.v1.NrfrequencyShift7P5Khz,oneof" json:"frequency_shift7p5khz,omitempty"`
}
...
type SupportedSulbandList struct {
	...
	Value []*SupportedSulfreqBandItem `protobuf:"bytes,1,rep,name=value,proto3" json:"value,omitempty"`
}
