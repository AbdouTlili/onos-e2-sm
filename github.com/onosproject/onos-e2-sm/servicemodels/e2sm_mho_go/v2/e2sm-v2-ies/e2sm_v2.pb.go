...
type InterfaceMessageId struct {
	...
	MessageType MessageType `protobuf:"varint,2,opt,name=message_type,json=messageType,proto3,enum=e2sm_mho_go.v2.MessageType" json:"message_type,omitempty"`
}
...
type RrcType_Lte struct {
	...
	Lte RrcclassLte `protobuf:"varint,1,opt,name=lte,json=lTE,proto3,enum=e2sm_mho_go.v2.RrcclassLte,oneof"`
}

type RrcType_Nr struct {
	// @inject_tag: aper:"choiceIdx:2,valueExt,valueLB:0,valueUB:7"
	Nr RrcclassNr `protobuf:"varint,2,opt,name=nr,json=nR,proto3,enum=e2sm_mho_go.v2.RrcclassNr,oneof"`
}
